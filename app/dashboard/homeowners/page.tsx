  ...
  return (
    <div className="">
      <div className="flex items-start justify-between gap-4 mb-3 flex-wrap">
        <div>
          <h1 className="text-[#000000] text-2xl md:text-3xl font-semibold font-sora mb-3">Homeowner Management </h1>
          <p className="text-[#B5BCC8] text-xl md:text-2xl font-normal font-roboto mb-10">Manage Homeowners status, inspections, and Payments</p>
        </div>
        <button
