...
export default function InspectionPayment() {
  // Sample data extracted from the design
  const inspectionData: InspectionDetails = {
    category: "Four Point Inspection",
    bookingDate: "May 20, 2026",
    scheduledTime: "May 28, 2026 • 10:30 AM",
    notes: "Homeowner requested comprehensive inspection of HVAC, electrical, plumbing, and roof. Property built in 1995, recent renovations to kitchen and bathrooms.",
    rescheduleHistory: [
      {
        date: "May 22, 2026",
        reason: "Inspector requested - weather conditions"
      }
    ]
  };
  ...
  // Calculations
  const subtotal = paymentData.inspectionFee + paymentData.urgentFee;
  const commissionAmount = subtotal * paymentData.platformCommissionRate;
  const inspectorPayout = subtotal - commissionAmount;
  ...
  <path d="M12.5007 1.66675H5.00065C4.55862 1.66675 4.1347 1.84234 3.82214 2.1549C3.50958 2.46746 3.33398 2.89139 3.33398 3.33341V16.6667C3.33398 17.1088 3.50958 17.5327 3.82214 17.8453C4.1347 18.1578 4.55862 18.3334 5.00065 18.3334H15.0007C15.4427 18.3334 15.8666 18.1578 16.1792 17.8453C16.4917 17.5327 16.6673 17.1088 16.6673 16.6667V5.83341L12.5007 1.66675Z" stroke="#5E65FF" stroke-width="1.66667" stroke-linecap="round" strokeLinejoin="round"/>
  <path d="M11.666 1.66675V5.00008C11.666 5.44211 11.8416 5.86603 12.1542 6.17859C12.4667 6.49115 12.8907 6.66675 13.3327 6.66675H16.666" stroke="#5E65FF" stroke-width="1.66667" stroke-linecap="round" strokeLinejoin="round"/>
  <path d="M8.33268 7.5H6.66602" stroke="#5E65FF" stroke-width="1.66667" stroke-linecap="round" strokeLinejoin="round"/>
  <path d="M13.3327 10.8333H6.66602" stroke="#5E65FF" stroke-width="1.66667" stroke-linecap="round" strokeLinejoin="round"/>
  <path d="M13.3327 14.1667H6.66602" stroke="#5E65FF" stroke-width="1.66667" stroke-linecap="round" strokeLinejoin="round"/>
</svg>
  ...
  <path d="M13.3327 14.1667H6.66602" stroke="#5E65FF" stroke-width="1.66667" stroke-linecap="round" strokeLinejoin="round"/>
              ...
              <div>
                ...
                <span className="text-sm font-medium leading-5 text-[#101828] font-roboto leading-5">{inspectionData.category}</span>
              </div>
            </div>
  ...
  <path d="M2.5 8.33325H17.5" stroke="#5E65FF" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
              ...
              <div>
                <span className="text-xs font-normal text-[#6A7282] font-roboto leading-4 block mb-1">Booking Date</span>
                <span className="text-sm font-medium leading-5 text-[#101828] font-roboto leading-5">{inspectionData.bookingDate}</span>
              </div>
            </div>
  ...
  <path d="M10 5V10L13.3333 11.6667" stroke="#5E65FF" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
              ...
              <div>
                ...
                <span className="text-sm font-medium leading-5 text-[#101828] font-roboto leading-5">{inspectionData.scheduledTime}</span>
              </div>
            </div>
          </div>
          ...
          {/* Reschedule History */}
          {inspectionData.rescheduleHistory && inspectionData.rescheduleHistory.length > 0 && (
            <div>
  ...
  <path d="M5.33333 10.6667H2V14.0001" stroke="#364153" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
              ...
              <div className="space-y-2">
                {inspectionData.rescheduleHistory.map((history, idx) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-7 space-y-4">
              <div className="flex justify-between items-center py-2 border-b border-slate-100 text-sm ">
                ...
                <span className="font-medium leading-6 text-[#101828] text-base">${inspectionData.category === "Four Point Inspection" ? paymentData.inspectionFee.toFixed(2) : "0.00"}</span>
              </div>
              
              <div className="flex justify-between items-center py-2 border-b border-slate-100 text-sm">
                <span className="text-[#4A5565] font-normal leading-5 font-roboto">Urgent Fee</span>
                <span className="font-medium leading-6 text-[#101828] text-base">+{`$${paymentData.urgentFee.toFixed(2)}`}</span>
              </div>

              <div className="flex justify-between items-center py-2 border-b border-slate-100 text-sm">
                <span className="text-[#4A5565] font-normal leading-5 font-roboto">Platform Commission ({paymentData.platformCommissionRate * 100}%)</span>
                <span className="font-medium leading-6 text-[#101828] text-base">-{`$${commissionAmount.toFixed(2)}`}</span>
              </div>
              ...
              <div className="bg-[#F0FDF4] border border-[#B9F8CF] rounded-xl p-4 flex justify-between items-center mt-6">
                ...
                <span className="text-[#008236] font-semibold text-base leading-6 font-roboto">${inspectorPayout.toFixed(2)}</span>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 space-y-5 lg:pl-6 ">
              ...
              <div className="flex items-start gap-3">
                <div className="text-slate-400 mt-0.5">
                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
  <g clip-path="url(#clip0_1715_2403)">
    ...
    <clipPath id="clip0_1715_2403">
      <rect width="16" height="16" fill="white"/>
                ...
                <div>
                  ...
                  <span className="text-sm font-medium text-[#101828] leading-5 font-roboto font-normal">{paymentData.paymentMethod}</span>
                </div>
              </div>
  ...
  <path d="M2 6.66675H14" stroke="#99A1AF" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
                ...
                <div>
                  ...
                  <span className="text-sm font-medium text-[#101828] leading-5 font-roboto font-normal">{paymentData.paidOn}</span>
                </div>
              </div>
