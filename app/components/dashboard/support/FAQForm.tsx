...
export default function FAQForm({ index, onPublish, loading }: FAQFormProps) {
    ...
    <div className="bg-white rounded-3xl border border-[#e2e5eb] p-5 sm:p-6">
      ...
      <div className="mb-4">
        <div className="flex items-center gap-2 border border-[#e2e5eb] p-4 rounded-[16px] focus-within:border-[#4f46e5] transition-colors">
          <span className="text-lg font-semibold font-sora text-gray-900 flex-shrink-0">{index}.</span>
          <input
            type="text"
            value={question}
