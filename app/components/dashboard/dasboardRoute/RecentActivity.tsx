...
export default function RecentActivity() {
          ...
          {activities.map((item) => {
            ...
            return (
              <div key={item.id} className="flex items-start gap-4">
                ...
                {/* Double Layered Micro-Glow Icon Badge */}
                <div className={`w-11 h-11 rounded-full flex items-center justify-center shrink-0 shadow-lg ${item.glowColor}`}>
  ...
  <div className="flex items-start justify-between gap-3">
    ...
    <h4 className="font-medium text-gray-900 text-sm leading-5 flex-1 min-w-0 break-words">
      {item.title}
    </h4>
  ...
  <p className="text-xs md:text-sm text-gray-600 mt-1 leading-4 break-words max-w-full">
    {item.description}
  </p>
