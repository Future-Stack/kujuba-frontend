...
export default function TopCategory() {
  return (
    <div className="w-full bg-white rounded-[28px] border border-gray-100  shadow-sm font-roboto flex flex-col justify-between ">
      <div>
        <h3 className="text-base md:text-lg font-bold text-gray-900  p-5 md:p-6 leading-5.5 m px-1 border-b border-gray-100 pb-4">Top Category</h3>
