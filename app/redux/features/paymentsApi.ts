...
export const paymentApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    >({
      ...
      // Normalize the nested response shape so consumers always get PaymentListResponse
    ...
    getPaymentMetrics: builder.query<PaymentMetricsResponse, void>({
    ...
    exportSinglePayment: builder.query<PaymentExportRow, number>({
